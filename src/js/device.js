export default class Device {
    ...
    isMobileDevice() { //got the regex online https://stackoverflow.com/questions/11381673/detecting-a-mobile-browser
        let check = false;

        check = this.isiOS(check);
        console.log(check);
    ...
    isiOS(check) {
        if (navigator.userAgent.includes('Mac') && !navigator.userAgent.includes('Mobile') && navigator.maxTouchPoints >= 1) {
            check = true
        }
        return check
    }
